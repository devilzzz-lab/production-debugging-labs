...
<p align="center">
    <img src="https://img.shields.io/badge/Status-Failed-ff4444?logo=githubactions&logoColor=white" alt="Artifact Missing">
</p>

<hr>

<h3>🚨 Issue Summary</h3>
<p><strong>Issue:</strong> CI/CD pipeline fails because expected artifact is not found between stages</p>
<p><strong>Impact:</strong> Deployment or next stage execution fails due to missing files</p>
